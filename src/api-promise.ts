...
import type { CoingeckoProApiTypescript } from './client.js';
...
export type ParseResponse<T> = (client: CoingeckoProApiTypescript, props: APIResponseProps) => T | Promise<T>;
...
export class APIPromise<T> extends Promise<T> {
  ...
  constructor(
    private readonly client: CoingeckoProApiTypescript,
