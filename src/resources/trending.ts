...
export class Trending extends APIResource {
   ...
   */
  search(params: TrendingSearchParams | null | undefined = {}, options?: RequestOptions): APIPromise<TrendingSearch> {
...
export interface TrendingSearch {
  coins?: Array<{ id?: string; coin_id?: number; name?: string; symbol?: string; market_cap_rank?: number; thumb?: string; small?: string; large?: string; slug?: string; price_btc?: number; score?: number; data?: { price?: number; price_btc?: string; price_change_percentage_24h?: { btc?: number; usd?: number }; market_cap?: string; market_cap_btc?: string; total_volume?: string; total_volume_btc?: string; sparkline?: string; content?: { title?: string; description?: string } | null } }>;
  ...
  categories?: Array<{ id?: number; name?: string; market_cap_1h_change?: number; slug?: string; coins_count?: number; data?: { market_cap?: number; market_cap_btc?: number; total_volume?: number; total_volume_btc?: number; market_cap_change_percentage_24h?: { btc?: number; usd?: number }; sparkline?: string } }>;
}
...
export declare namespace Trending {
  export { type TrendingSearch as TrendingSearch, type TrendingSearchParams as TrendingSearchParams };
}
