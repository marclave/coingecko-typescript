...
export class NewPools extends APIResource {
   ...
   */
  get(params: NewPoolGetParams | null | undefined = {}, options?: RequestOptions): APIPromise<Pool> {
   ...
   */
  getNetwork(network: string, params: NewPoolGetNetworkParams | null | undefined = {}, options?: RequestOptions): APIPromise<Pool> {
    const { include, page, include_gt_community_data } = params ?? {};
...
export declare namespace NewPools {
  export { type Pool as Pool, type NewPoolGetParams as NewPoolGetParams, type NewPoolGetNetworkParams as NewPoolGetNetworkParams };
}
