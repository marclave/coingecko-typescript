...
export class MarketChart extends APIResource {
   ...
   */
  get(id: string, contract_address: string, params: MarketChartGetParams, options?: RequestOptions): APIPromise<CoinsMarketChart> {
   ...
   */
  getRange(id: string, contract_address: string, params: MarketChartGetRangeParams, options?: RequestOptions): APIPromise<CoinsMarketChart> {
